...
<style>
  ...
  *{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--text);font-family:var(--vscode-font-family);font-size:13px}
  ...
  .tabs{display:flex;gap:6px;overflow:auto;padding:10px 10px 0}.tabs button{border:1px solid var(--line);background:var(--panel2);color:var(--muted);border-radius:7px;padding:8px 9px;white-space:nowrap;cursor:pointer}.tabs button.active{color:white;border-color:var(--purple);background:rgba(168,85,247,.22)}
